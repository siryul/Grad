...
__all__ = [
  'Classifier', 'ResNet', 'resnet10', 'resnet10_fe', 'resnet18', 'resnet34', 'resnet50',
  'resnet50_fe', 'resnet101', 'resnet101_fe', 'resnet152', 'resnet152_fe', 'resnext50_32x4d',
  'resnext101_32x8d', 'resnext152_32x4d', 'wide_resnet50_2', 'wide_resnet101_2'
]
...
def resnet10_fe(pretrained=False, progress=True, **kwargs):
  r"""ResNet-18 model from
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
  return _resnet_fe('resnet10_fe', BasicBlock, [1, 1, 1, 1], pretrained, progress, **kwargs)
...
def resnet50_fe(pretrained=False, progress=True, **kwargs):
  r"""ResNet-18 model from
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
  return _resnet_fe('resnet50_fe', Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs)
...
def resnet101_fe(pretrained=False, progress=True, **kwargs):
  r"""ResNet-101 model from
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
  return _resnet_fe('resnet101_fe', Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)
...
def resnet152_fe(pretrained=False, progress=True, **kwargs):
  r"""ResNet-152 model from
    ...
    """
  return _resnet_fe('resnet152_fe', Bottleneck, [3, 8, 36, 3], pretrained, progress, **kwargs)
